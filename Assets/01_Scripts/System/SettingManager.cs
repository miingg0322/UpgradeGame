...
public enum KeyAction { UP, DOWN, LEFT, RIGHT, DASH, SKILL, ATTACK, INTERACTION, INVENTORY, KEYCOUNT }
...
{   
    ...
    KeyCode[] defaultKeys = new KeyCode[] { KeyCode.W, KeyCode.S, KeyCode.A, KeyCode.D, KeyCode.LeftShift, KeyCode.R, KeyCode.Mouse0, KeyCode.Space, KeyCode.I };
    private void Awake()
    {
        InitKeySetting();
    }
